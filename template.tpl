...

{
  ...
  "description": "This is a cookie consent template for CookieLegit, a CMP designed for WordPress. For more information visit https://www.cookielegit.site/docs",
  "containerContexts": [
    "WEB"
  ]
}
...
Created on 3/10/2025, 6:32:31 PM
